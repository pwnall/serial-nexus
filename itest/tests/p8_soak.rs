...
//!
//! Topology (no hardware, §15.17): a paced firehose device (`serial-nexus-sim pty --source
...
//! This needs a software serial *source* — a `serial-nexus-sim pty --source` flooding a
