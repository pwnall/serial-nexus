...
//!    residual", the quieter half and the one LEG-2 was. The peer is a `serial-nexus-sim wire
...
use serial_nexus_itest::{Daemon, Rpc, Sim, TempRun, sha256_hex, wait_until};
...
/// `serial_nexus_codec_api::MAX_FRAME_SIZE`, restated as a literal rather than depended on: this
...
///
/// The peer is `serial-nexus-sim wire --stall`: a conforming handshake, an announced channel,
