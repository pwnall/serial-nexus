...
//!
//! The first test needs a serial device (a `nexus-sim pty --source` standing in for the
...
use nexus_itest::{Daemon, Rpc, Sim, Subscription, serial_echo, sha256_hex, wait_until};
