...
// The binary's entry points. `serialnexusweb` is a binary that happens to have a
...
///
/// Review 26's SEC-7 observed that every fuzz target sat on the `codec-api` layer,
