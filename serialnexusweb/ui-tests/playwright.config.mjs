...
// `serialnexusweb` are started by the Rust gate `nexus-itest/tests/p8_web_ui.rs`, which
...
if (!url) {
  throw new Error(
    "SNX_WEB_URL is unset — this suite is launched by nexus-itest's p8_web_ui gate, " +
      "which boots the daemon, the sim devices and serialnexusweb and passes the " +
      "bootstrap URL. Run `cargo test -p nexus-itest --test p8_web_ui` instead of " +
