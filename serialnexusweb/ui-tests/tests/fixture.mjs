// The contract between the Rust gate (`nexus-itest/tests/p8_web_ui.rs`) and these
...
// operator would — over the control socket, with `serialnexusctl`. That the browser
...
/** The echo console — a serial node over a `nexus-sim pty --echo` device. */
...
/** Run `serialnexusctl --json <args…>` against the gate's daemon and return the result. */
