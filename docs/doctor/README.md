...
| [`linux-7.0-2026-08-21-25d8ecd-tier3-3.json`](linux-7.0-2026-08-21-25d8ecd-tier3-3.json) | ” — third sequential run; the eight handshake cells are identical in all three, and `jq -e -f expectations/linux.jq` exits 0 on all three | ” | ” | ” | ” | ” |
