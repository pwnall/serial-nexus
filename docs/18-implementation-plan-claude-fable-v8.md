...
Design §15.26 is the rationale; these items make a separate closed-source codec repository a supported, CI-proven pattern. Priority-ordered, agent-validated.
